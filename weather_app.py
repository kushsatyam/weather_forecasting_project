...
#API_KEY = os.environ['https://api.openweathermap.org/data/3.0/onecall?lat={lat}&lon={lon}&exclude={part}&appid=a900e8647d1bbd385cd4e68098083d92']
owm = pyowm.OWM('a900e8647d1bbd385cd4e68098083d92')
